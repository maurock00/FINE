...
$auxsql= "SELECT MAX(codigoBlessed) as max FROM Blessed"; 
...
$auxsql= "SELECT *FROM Blessed WHERE codigoBlessed='$id'"; 
...
while (!$rs2->EOF) {
	...
	$p21 = $rs2->fields[23];$p22 = $rs2->fields[24];
	$rs2->MoveNext();
}
...
$grafico->title->Set('Puntuacion del Usuario para BLESSED');
